...
3. Lorenzo worked on the Facebook API as well as the Spoonacular API. He also helped with the Clarifai API.  He set up the SQLite functionality as well and created Custom View for SQLite data display.
